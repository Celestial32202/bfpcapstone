...
$pending_reports = getPendingReportsCount($conn);
?>
<!-- Begin Page Content -->
                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                Fire Incident Reports (Monthly)</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                <?php echo $monthly_reports; ?>
                            </div>
                        </div>
                        <div class="col-auto">
                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                Fire Incident Reports (Today)</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                <?php echo $today_reports; ?>
                            </div>
                        </div>
                        <div class="col-auto">
    ...
    <div class="row">
        ...
        <div class="col-xl-4 col-lg-5">
            <div class="card shadow mb-4">
                <!-- Card Header - Dropdown -->
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">Reports Pie Chart</h6>
                    <div class="dropdown no-arrow">
                        <a class="dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown"
                            aria-haspopup="true" aria-expanded="false">
                            <i class="fas fa-ellipsis-v fa-sm fa-fw text-gray-400"></i>
