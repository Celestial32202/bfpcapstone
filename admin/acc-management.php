...
<div class="container-fluid">
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">Registered Accounts</h1>
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Live Accounts</h6>
        </div>
        <div class="card-body">
            <div class="table-responsive">
                <?php
                $query = "SELECT * FROM admin_creds WHERE is_deleted = 0 AND username != 'coh_admin'";
                ...
                <table class="table table-bordered" id="usersTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr data-user-id="<?php echo $row['admin_id']; ?> ">
                            ...
                            <td><?php echo $row['username']; ?><?php echo $row['admin_id']; ?></td>
                            ...
                            <td>
                                <i class="fas fa-edit text-info fa-lg edit-user" title="Edit Account"
                                    style="cursor: pointer;"></i>

                                <!-- Delete Icon (Trash) -->
                                <i class="fas fa-trash text-danger fa-lg delete-user" title="Delete"
                                    style="cursor: pointer;"></i>

                                <!-- Locked Icon (Lock) -->
                                <?php
                                        if ($row['is_locked'] == 1) {
                                            echo '<i class="fas fa-lock-open text-warning fa-lg unlock-user" title="Unlock" style="cursor: pointer;"></i>';
                                        } else {
                                            echo '<i class="fas fa-lock text-warning fa-lg lock-user" title="Locked" style="cursor: pointer;"></i>';
                                        }
                                        ?>
                            </td>
                        </tr>
